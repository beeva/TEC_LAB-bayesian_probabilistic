...
def create_venv(path_experiment, path_utils):
    ...
    if platform.system() == 'Windows':
        path_python = os.path.join(path_venv, "Scripts", "python")
    else:
    ...
    if platform.system() == 'Windows':
        path_dest_utils =  os.path.join(path_venv, 'Lib', 'site-packages', 'utils')
    else:
        path_dest_utils = os.path.join(path_venv, 'lib', os.listdir(os.path.join(path_venv, 'lib'))[0], 'site-packages',
                                       'utils')
